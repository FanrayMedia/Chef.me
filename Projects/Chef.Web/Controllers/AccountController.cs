...
using Chef.Web.Models.Accounts;
...
{
    [Authorize]
    public class AccountController : ChefMvcController
    {
        ...
        /// <summary>
        /// Registers a new user after the user login with an external account for the first time.
        /// </summary>
